...
urlpatterns = [
    ...
    path('martian-enterprise/players', PlayersView.as_view(), name="players"),
    path('martian-enterprise/inspectplayer', views.PlayerView.as_view(), name="inspectplayer"),
    path('martian-enterprise/inspectplayer/<int:player_id>', views.PlayerView.as_view(), name="inspectplayer"),
